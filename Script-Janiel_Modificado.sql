...
BULK Insert Paises
From 'C:\Users\janiel\Desktop\ETEC - Desen. sistemas\2º Modulo\BD II - Nelson\Projeto_Pedidos\aula 26.08.2021\Tabela_Paises.txt'
With
(fieldterminator = ';',
rowterminator = '\n'
)
...
From 'C:\Users\janiel\Desktop\github Banco de Dados\Projeto_Pedidos em andamento\Tabela_Tipos_Logradouros.txt'
With
(fieldterminator = ';',
rowterminator = '\n'
)
...
-- Values (01, 'janiel Maia', '132.845.659-56', '51.541.454-1', '20210902', 'janiellmaia@gmail.com' )
...
Values ('janiel Maia', '132.845.659-56', '51.541.454-1', '20210902', 'janiellmaia@gmail.com')

Insert Into Vendedores
(Nome_Vendedor, Cpf_Vendedor, Rg_Vendedor, Data_Cadastro_Vendedor, Email_Vendedor)
Values ('Priscilla Minelli', '654.845.658-52', '41.331.542-2', '20210902', 'Prih.Minelli@gmail.com')

Insert Into Vendedores
(Nome_Vendedor, Cpf_Vendedor, Rg_Vendedor, Data_Cadastro_Vendedor, Email_Vendedor)
Values ('Emilly Faria Minelli', '124.321.456-45', '51.631.211-1', '20210902', 'emyzinha@gmail.com')

Select * From Vendedores
where Email_Vendedor like '%Prih%'

Update Vendedores set Email_Vendedor = 'prih.minelli@gmail.com'
where Email_Vendedor LIKE '%Prih%'
...
From 'C:\Users\janiel\Desktop\ETEC - Desen. sistemas\2º Modulo\BD II - Nelson\Projeto_Pedidos\Cadastro_Teste-janiel.txt'
With
(fieldterminator = ';',
rowterminator = '\n'
)
...
BULK Insert Cidades
From 'C:\Users\janiel\Desktop\github Banco de Dados\Projeto_Pedidos em andamento\Cidades_Reduzidas.txt'
With
(fieldterminator = ';',
rowterminator = '\n'
)

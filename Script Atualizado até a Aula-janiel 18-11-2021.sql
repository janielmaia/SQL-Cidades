...
--
-- Removendo os Registros da Tabela Paises com a cl�usula IN
--
...
--- utilizando o utilit�rio BULK
---

BULK Insert Paises
From 'C:\Users\Aluno\Desktop\janiel\Projeto-Pedidos-SQL-Server\Tabela_Paises.txt'
With
(fieldterminator = ';',
rowterminator = '\n'
)
...
From 'C:\Users\Aluno\Desktop\janiel\Projeto-Pedidos-SQL-Server\Tabela_Tipos_Logradouros.txt'
With
(fieldterminator = ';',
rowterminator = '\n'
)
...
BULK Insert Cidades
From 'C:\Users\Aluno\Desktop\janiel\Projeto-Pedidos-SQL-Server\Tabela_Cidades_Reduzidas.txt'
With
(fieldterminator = ';',
rowterminator = '\n'
)
...
values ('ARROZ EMP�RIO SAO JOAO 5 KG',
         19.500,
         25.000,
         '20211118')

INSERT INTO Produtos
values ('ARROZ TIO Z� 5 KG',
         13.500,
         18.000,
         '20211118')

Update Produtos set Descricao_Produto = 'ARROZ CARUNCH�O 10KG'
...
SELECT * FROM Itens_Pedidos
 ...
 --- Exibindo algumas colunas da tabela de Cidades
 --- incluindo um apelido para a tabela utilizando
 --- a cl�usula Where e a cl�usula Order By, Like
 ...
 --- e o nome da pais que est� na tabela de
 --- Paises e trocando o nome das colunas
 --- incluindo um apelido para a tabela utilizando
 --- a cl�usula Where como relacionamento
 
 Select Cid.Codigo_Cidade as 'C�digo',
        Cid.Nome_Cidade as 'Nome',
 	   Cid.Uf_Cidade as 'Estado',
 	   Cid.Codigo_Pais as 'Pais',
 	   Pai.Descricao_Pais as 'Nome do Pa�s'
 ...
 --- Paises e trocando o nome das colunas
 --- incluindo um apelido para a tabela utilizando
 --- a cl�usula Inner Join como relacionamento
